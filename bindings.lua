...
senduserprofilephotos = function (chat_id,find_id,caption)
	...
	sendPhotoID(chat_id,photo.result.photos[1][1].file_id,caption)
end
...
sendContact = function(chat_id, phone_number, first_name, last_name, reply_to_message_id, disable_notification)
	...
	local url = BASE_URL .. '/sendContact?chat_id=' .. chat_id .. '&phone_number=' .. phone_number .. '&first_name=' .. URL.escape(first_name)
