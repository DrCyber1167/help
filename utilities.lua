...
--inline
function inline_block(title, text, description, thumburl)
  local ran = math.random(1 ,100)
  local inline = '{"type":"article", "id":"'.. ran ..'", "title":"'.. title ..'", "message_text": "'.. text ..'", "parse_mode":"Markdown", "description":"'.. description ..'", "thumb_url":"'.. thumburl ..'"}'
  return inline
end
